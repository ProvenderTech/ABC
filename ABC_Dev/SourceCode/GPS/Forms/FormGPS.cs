...
namespace ABC
{
    ...
    public partial class FormGPS : Form
    {
        ...
        //The base directory where ABC will be stored and fields and vehicles branch from
        ...
        private void FormGPS_Load(object sender, EventArgs e)
        {
            ...
            if (Settings.Default.setF_workingDirectory == "Default")
                baseDirectory = Environment.GetFolderPath(Environment.SpecialFolder.MyDocuments) + "\\ABC\\";
            else baseDirectory = Settings.Default.setF_workingDirectory + "\\ABC\\";
        ...
        private void JobNewOpenResume()
        {
            ...
            if (!isJobStarted)
            {
                ...
                Text = "ABC - " + currentFieldDirectory;
            }
