...
namespace ABC
{
    public partial class Form_About : Form
    {
        ...
        private void Form_About_Load(object sender, EventArgs e)
        {
            ...
            LinkLabel.Link link = new LinkLabel.Link { LinkData = "https://github.com/farmerbriantee/ABC" };
            linkLabelGit.Links.Add(link);

            // Add a link to the LinkLabel.
            LinkLabel.Link linkCf = new LinkLabel.Link
            {
                LinkData = "http://www.thecombineforum.com/forums/31-technology/278810-ABC.html"
            };
